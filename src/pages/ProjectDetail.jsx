          ...
          <Link to="/projects" className="back-to-projects-btn">
            <div className="back-btn-content">
              <div className="back-text-container">
                ...
                <span className="alt-text">GO BACK</span>
              </div>
  ...
  return (
    ...
    >
      ...
      <section className="project-content-visual">
        ...
        {/* Single Back to Projects Button at Bottom - Updated with Smooth Animation */}
        <motion.div 
        ...
        >
          <Link 
            to="/projects" 
            className={`back-to-projects-btn ${isHovered ? 'hover' : ''}`}
